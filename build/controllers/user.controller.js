      ...
      while (1) switch (_context.prev = _context.next) {
        case 0:
          ...
          return _context.abrupt("return", res.status(400).json({
            error: 'Save failed.',
            message: 'Please submit a user.'
          }));
        case 3:
          _context.prev = 3;
          newUser = new _User["default"](user);
          _context.next = 7;
          return _User["default"].validate(newUser);
        case 7:
        ...
        case 10:
          ...
          return _context.abrupt("return", res.status(400).json({
            error: 'Save failed',
            message: 'Invalid user data. Please check the submitted user.'
          }));
        case 13:
        case "end":
    ...
    return _regeneratorRuntime().wrap(function _callee4$(_context4) {
      while (1) switch (_context4.prev = _context4.next) {
        ...
        case 6:
          ...
          return _context4.abrupt("return", res.json(updatedUser));
        case 8:
        case "end":
