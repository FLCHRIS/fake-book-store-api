...
exports.updateBook = exports.getBooks = exports.getBook = exports.deleteBook = exports.createBook = void 0;
      ...
      while (1) switch (_context2.prev = _context2.next) {
        case 0:
          _ref3 = req.query || {
            limit: 0,
            offset: 0
          }, limit = _ref3.limit, offset = _ref3.offset;
          _context2.prev = 1;
          _context2.next = 4;
          return _Book["default"].find().skip(offset).limit(limit);
        case 4:
          books = _context2.sent;
          return _context2.abrupt("return", res.json(books));
        case 8:
          _context2.prev = 8;
          _context2.t0 = _context2["catch"](1);
          return _context2.abrupt("return", res.status(500).json({
            error: 'Get books failed.',
...
var getBook = exports.getBook = /*#__PURE__*/function () {
      ...
      while (1) switch (_context3.prev = _context3.next) {
        case 0:
          ...
          return _context3.abrupt("return", res.status(400).json({
            ...
            message: 'Please submit a valid ID.'
          }));
        case 3:
          _context3.prev = 3;
          _context3.next = 6;
        ...
        case 6:
          ...
          return _context3.abrupt("return", res.status(404).json({
            error: 'Get book failed.',
            message: 'Book not found.'
          }));
        case 9:
          return _context3.abrupt("return", res.json(book));
        case 12:
          _context3.prev = 12;
          _context3.t0 = _context3["catch"](3);
          return _context3.abrupt("return", res.status(500).json({
            error: 'Internal Server Error.',
            message: 'There was an error getting the book.'
          }));
        case 15:
        case "end":
    ...
    return _regeneratorRuntime().wrap(function _callee4$(_context4) {
      while (1) switch (_context4.prev = _context4.next) {
        ...
        case 6:
          ...
          return _context4.abrupt("return", res.json(updatedBook));
        case 8:
        case "end":
